...
public class IndicatorView extends View implements Indicator {
    ...
    private int count;
    private int unColor = Color.WHITE;
    ...
    @Override
    public void initIndicatorCount(int count, int currentIndex) {
        this.count = count;
    ...
    private int measureWidth(int widthMeasureSpec) {
        ...
        switch (mode) {
            ...
            case MeasureSpec.UNSPECIFIED:
                ...
                float diameterDistance = Math.max(ratioSelectedRadius, ratioRadius) * 2 * count;
                float spacingDistance = (count - 1) * indicatorSpacing;
    ...
    private void drawCircle(Canvas canvas, float midY) {
        ...
        float nextIndicatorStartX = indicatorStartX((selectedPage + 1) % count);
    ...
    private void drawDash(Canvas canvas, float midY) {
        ...
        int nextPage = (selectedPage + 1) % count;
